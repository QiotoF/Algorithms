 ...
 */
public class Exercise41_RunningTimes {
    ...
    private static void runExperiments(int sumMethod) {
        Exercise41_RunningTimes runningTimes = new Exercise41_RunningTimes();

        double previousTime = runningTimes.timeTrial(125, sumMethod);

        StdOut.printf("%6s %7s %5s\n", "N", "Time", "Ratio");

        for(int n = 250; n <= 8000; n += n) {
            double time = runningTimes.timeTrial(n, sumMethod);
